	...
	//Realizamos la consulta a la tabla correspondiente
       ...
       $datos2=array();
              $data2 = sparql_get( "http://localhost:8890/sparql","
                     select ?provincia ?canton ?parroquia ?institucion ?lang ?long ?np ?inst ?tlf where {
                        ?institucion <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://dbpedia.org/ontology/Institucion>.
                        ?institucion <http://dbpedia.org/ontology/Langitude> ?long.
                        ?institucion <http://dbpedia.org/ontology/Longitude> ?lang.
                        ?institucion <http://dbpedia.org/ontology/isPartOf> ?parroquia.
                        ?institucion <http://dbpedia.org/ontology/phone> ?tlf.
                        ?institucion <http://www.w3.org/2000/01/rdf-schema#label> ?inst.
                        ?parroquia <http://dbpedia.org/ontology/isPartOf>  ?canton.
                        ?canton  <http://dbpedia.org/ontology/isPartOf> ?provincia.
                        ?provincia <http://www.w3.org/2000/01/rdf-schema#label> ?np.
                        filter(regex(?provincia, '$trans' )) 
                        }
...
$marker_pintar = ""; 
              foreach( $data2 as $row )
                        ...
                        $datos2[]=array("np"=>$row["np"]);
                         $marker_pintar .= "['".$row["inst"]."','".$row["long"]."','".$row["lang"]."','".$row["tlf"]."'],";
                      }                       
...
<div class="header">
	<div class="container">
		<div class="header-main">
			  <div class="logo">
			  	<h1><a href="index.php">Instituciones  de educación inclusiva Ecuador</a></h1>
...
<div class="copyright">
	<div class="container">
	   <div class="copy-main">
			<p>© 2015 Cardenas Ana y Jefferson leon  <a href="" target="_blank">  Redes </a></p>
	   </div>
	   <script type="text/javascript">
										$(document).ready(function() {
											/*
      ...
      for (i = 0; i < locations.length; i++)
       {  
           ...
           latlngset = new google.maps.LatLng(lat, long);
            ...
            var content = "Nombre institucion: " + loan +  '</h3>' +'<br>'+ "Telefono: " + add  + "<img>"    
