...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBgDkVqIMYa2fLVyHujrOvRMysDydEBHNk"></script>
<!-- Custom Theme files -->
      ...
      for (i = 0; i < locations.length; i++)
       {  
           ...
           latlngset = new google.maps.LatLng(lat, long);
            ...
            var content = "Nombre: " + loan +  '</h3>' +'<br>'+ "Telefono: " + add  + "<img>"    
