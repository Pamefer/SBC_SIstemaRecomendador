<?php 
  ...
  //Realizamos la consulta a la tabla correspondiente
      ...
      # $datos2=array();
              $data2 = sparql_get( "SELECT ?recurso ?lat ?long WHERE { ?recurso <http://www.w3.org/1999/02/22-rdf-syntax-ns#type>  <http://idi.fundacionctic.org/cruzar/turismo#Entorno-natural> .
...
$marker_pintar = ""; 
              foreach( $data2 as $row )
                        ...
                        #$datos2[]=array("recurso"=>$row["recurso"]);
